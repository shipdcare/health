...
<head>
  ...
  <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/angular-i18n/1.6.6/angular-locale_fr.min.js"></script>
      ...
      <div layout-gt-md="row" layout="column" layout-align-gt-md="center center">
        <md-input-container flex-gt-md="30">
          ...
          <input time="false" date="true" mdc-datetime-picker type="text" id="date"
                 placeholder="Date" click-outside-to-close="true" show-todays-date
